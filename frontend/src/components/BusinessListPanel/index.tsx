...
export function BusinessListPanel() {
    const { showBusinessList, toggleBusinessList, setFlyToRequest, setSelectedBusiness, showBusinesses, toggleBusinesses } = useMapStore();
    ...
    const handleSelect = (b: BusinessFeature) => {
        ...
        setFlyToRequest({ lat: b.lat, lon: b.lon, alt: 400, label: b.name });
    };
