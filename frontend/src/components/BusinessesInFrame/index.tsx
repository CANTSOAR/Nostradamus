...
export function BusinessesInFrame() {
    const { showBusinesses, setSelectedBusiness, setFlyToRequest } = useMapStore();
                        ...
                        return (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    // Camera 350 m above → -35° pitch → business is clearly in frame
                                    setFlyToRequest({ lat: b.lat, lon: b.lon, alt: 350, label: b.name });
                                }}
                                style={{
