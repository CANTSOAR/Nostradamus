export type VariableKey =
  ...
  | "avg_annual_wage"
  | "certified_biz_count"
  // --- Municipality: total biz / total wage ---
  | "private_establishments"
  // --- Municipality: sector establishment counts ---
  | "sec_healthcare"
  | "sec_retail"
  | "sec_hospitality"
  | "sec_professional"
  ...
  | "sec_wholesale"
  | "sec_other"
  // --- Municipality: sector average annual wages ---
  | "wage_healthcare"
  | "wage_retail"
  | "wage_hospitality"
  | "wage_professional"
...
export interface VariableConfig {
  ...
  label: string;
  description: string;
  group: "regional" | "municipality_total" | "municipality_sector_count" | "municipality_sector_wage";
...
export const VARIABLES: VariableConfig[] = [
  // Regional
  { key: "median_income", label: "Median Income", group: "regional", description: "Median household income (ACS 5-yr, 2023)", colorScheme: "RdYlGn", higherIsBetter: true, format: fmtCurrency },
  { key: "poverty_rate", label: "Poverty Rate", group: "regional", description: "Share of population below poverty line (ACS, 2023)", colorScheme: "OrRd", higherIsBetter: false, format: fmtPct },
  { key: "unemployment_rate", label: "Unemployment Rate", group: "regional", description: "Share of labor force unemployed (ACS, 2023)", colorScheme: "OrRd", higherIsBetter: false, format: fmtPct },
  { key: "county_employment", label: "County Employment", group: "regional", description: "Annual avg employment by county (BLS QCEW, 2023)", colorScheme: "Blues", higherIsBetter: true, format: fmtInt },
  { key: "avg_annual_wage", label: "Avg Annual Wage", group: "regional", description: "Weighted avg wage per private-sector worker by county", colorScheme: "YlGnBu", higherIsBetter: true, format: fmtCurrency },
  { key: "certified_biz_count", label: "Certified Businesses", group: "regional", description: "NJ state-certified businesses (MBE/WBE/SBE) per county", colorScheme: "Purples", higherIsBetter: true, format: fmtInt },

  // Municipality totals
  { key: "private_establishments", label: "Total Businesses", group: "municipality_total", description: "Total private-sector establishments (BLS QCEW, 2023)", colorScheme: "Purples", higherIsBetter: true, format: fmtInt },

  // Sector counts
  { key: "sec_healthcare", label: "Healthcare Biz", group: "municipality_sector_count", description: "Healthcare establishment count", colorScheme: "Greens", higherIsBetter: true, format: fmtInt },
  { key: "sec_retail", label: "Retail Biz", group: "municipality_sector_count", description: "Retail establishment count", colorScheme: "Greens", higherIsBetter: true, format: fmtInt },
  { key: "sec_hospitality", label: "Hospitality Biz", group: "municipality_sector_count", description: "Hospitality & food service establishment count", colorScheme: "Greens", higherIsBetter: true, format: fmtInt },
  { key: "sec_professional", label: "Professional Biz", group: "municipality_sector_count", description: "Professional services establishment count", colorScheme: "Greens", higherIsBetter: true, format: fmtInt },
